...
function spcaf(cb) {
  ...
  var logQueue = [];
  var progress = 0;
  var app = spawn('D:\\SharePoint\\Project\\Document\\SPFX-Knockout-FormCRUD1.2\\spcaf.exe', ['-i', __dirname, '-r', 'HTML', '-o', __dirname + '\\report.xml', '-v', 'detailed', '-s', __dirname + '\\SharePointFramework.spruleset']);
